...
saveRDS(brt_all_no_gedi, paste0("./sdm_analysis/sdms/", species, "_dist_model_no_gedi.RDS"))
...
saveRDS(brt_gedi, paste0("./sdm_analysis/sdms/", species, "_dist_model_gedi_only.RDS"))
