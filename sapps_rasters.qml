...
<qgis version="3.16.0-Hannover" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer grayBand="1" type="singlebandgray" alphaBand="-1" opacity="1" gradient="BlackToWhite" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
